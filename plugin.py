...
"""
"""
<plugin key="VRRTSLite" name="AC RTS Blind LITE" author="Erwanweb" version="0.0.2" externallink="https://github.com/Erwanweb/VRRTSLite.git">
    <description>
        <h2>Control of RTS blinds for CASA-IA</h2><br/>
        Easily control RTS blinds with Rfxcom<br/>
